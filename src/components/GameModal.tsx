...
import { X, Terminal, Trophy, Clock, Play, RefreshCw, Zap, Save, Globe, Skull, RotateCcw } from 'lucide-react';
                    ...
                    <div className="game-content">
                        {gameState === 'cheated' ? (
                            <div className="cheat-view" style={{ textAlign: 'center', color: '#ef4444' }}>
                                ...
                                <button className="btn btn-primary" onClick={resetSite} style={{ background: '#ef4444', color: 'white' }}>
                                    <RotateCcw size={20} />
                                    Sistemi Onar
                                </button>
                            </div>
